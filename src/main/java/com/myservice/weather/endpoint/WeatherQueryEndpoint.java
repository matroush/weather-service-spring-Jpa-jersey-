...
public interface WeatherQueryEndpoint {
    ...
    Response weather(@PathParam("iata") String iata, @PathParam("radius") String radiusString) throws WeatherException;
    ...
    @Path("/weather/rainy/")
    @Produces(MediaType.APPLICATION_JSON)
    Response getRainyAtmosphericInfo() throws WeatherException;
