...
public class WeatherClient {
	...
	public WeatherClient() {
		...
		/*
		 * addAirport("BOS", 42.364347, -71.005181); addAirport("EWR", 40.6925,
		 * -74.168667); addAirport("JFK", 40.639751, -73.778925);
		 * addAirport("LGA", 40.777245, -73.872608); addAirport("MMU", 40.79935,
		 * -74.4148747);
		 */
		...
		WebTarget path = null;
		path = collect.path("/airport/BOS/42.364347/-71.005181");
		path.request().post(Entity.json(null));
		path = collect.path("/airport/EWR/40.6925/-74.168667");
		path.request().post(Entity.json(null));
		path = collect.path("/airport/JFK/40.639751/-73.778925");
		path.request().post(Entity.json(null));
		path = collect.path("/airport/LGA/40.777245/-73.872608");
		path.request().post(Entity.json(null));
		path = collect.path("/airport/MMU/40.79935/-74.4148747");
		path.request().post(Entity.json(null));
