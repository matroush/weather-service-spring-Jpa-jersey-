package com.myservice.weather.domain;
...
public class AtmosphericInformation {
    ...
    public AtmosphericInformation(String iata) {
    	this.iata=iata;
    ...
    public AtmosphericInformation(String iata , DataPoint temperature, DataPoint wind, DataPoint humidity, DataPoint percipitation, DataPoint pressure, DataPoint cloudCover) {
